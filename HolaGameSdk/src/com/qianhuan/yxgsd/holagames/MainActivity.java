...
//	ScrollView mScrollView; 
	...
	private void doInitView(){
		...
		findViewById(ResUtil.getId(this, "btn_change_theme")).setOnClickListener(new OnClickListener() {
	...
	public void getToken(String code) {
		...
		String url = "http://139.129.21.196/hola_sdk_server/login_state_check.php";
