package com.holagames.xcds.pay.weixinpay;
...
public class LyWeixinPay extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		appayBtn.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				ToastUtils.show(LyWeixinPay.this, "XXXXXXX");
				sendPayReq();
			}
		});
	...
	private class GetPrepayIdTask extends AsyncTask<Void, Void, Map<String,String>> {
		...
		protected void onPreExecute() {
			dialog = ProgressDialog.show(LyWeixinPay.this, getString(R.string.app_tip), getString(R.string.getting_prepayid));
		}
   ...
   //
	private String genProductArgs() {
		...
		try {
			...
			packageParams.add(new BasicNameValuePair("body", "钻石"));
